    ...
    <div style={{minHeight:'100vh', background:'#0d0d0d'}}>
      ...
      <div style={{maxWidth:900, margin:'0 auto', padding:'32px 24px'}}>
        ...
        <div style={{display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:28}}>
          <div>
            <h2 style={{color:'#E3D5BB', fontSize:20, fontWeight:300, letterSpacing:'0.04em'}}>My Submissions</h2>
            <p style={{color:'#4a4a3a', fontSize:12, marginTop:4, letterSpacing:'0.02em'}}>Track your academic activities</p>
          </div>
        ...
        <div style={{borderTop:'1px solid rgba(200,170,111,0.06)', paddingTop:20}}>
          ...
          {submissions.length === 0 ? (
            <div style={{border:'1px dashed rgba(200,170,111,0.1)', borderRadius:8, padding:60, textAlign:'center'}}>
              ...
              <p style={{color:'#4a4a3a', fontSize:12, letterSpacing:'0.04em'}}>No submissions yet</p>
              <p style={{color:'#2a2a1a', fontSize:11, marginTop:4}}>Click "New Submission" to get started</p>
            </div>
          ) : (
